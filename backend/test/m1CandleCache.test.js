...
describe('evaluateCoverageDecision — the core cache-vs-fetch decision', () => {
  ...
  test('tail gap that is purely non-trading time (e.g. we have data up to Friday close) -> complete', () => {
    // The 12 Sep extension to 23:00 was reverted on 22 Sep, so the close is
    // 21:00 UAE again and this fixture moves back with it.
    const friClose   = Date.UTC(2026, 7, 7, 17, 0, 0); // Fri 21:00 UAE = market close
